      ...
      <div className="flex lg:flex-row flex-col-reverse lg:ml-10">
        <div className=" flex flex-col justify-center items-center">
          <div className="mt-5 font-Poppins lg:w-[500px] w-full text-center lg:text-start">
            <h2 className="md:text-[36px] text-2xl leading-10 font-poppins font-semibold lg:line-clamp-3">{`Your one step Solution for all Documents Need 100% Free & Effortless`}</h2>
